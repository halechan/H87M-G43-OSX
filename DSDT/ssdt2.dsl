 ...
 * 
 * Disassembly of acpi_ssdt2.aml, Sat Jun 14 22:16:17 2014
 *
 ...
 */
DefinitionBlock ("SSDT-2.aml", "SSDT", 1, "SataRe", "SataTabl", 0x00001000)
{
    ...
    {
        Name (REGF, One)
        Method (REG, 2, NotSerialized)  // _REG: Region Availability
        {
            If (LEqual (Arg0, 0x02))
            {
                Store (Arg1, REGF)
