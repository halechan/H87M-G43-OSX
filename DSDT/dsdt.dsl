 ...
 * 
 * Disassembly of acpi_dsdt.aml, Sat Jun 14 22:09:49 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000D76B (55147)
 *     Revision         0x02
 *     Checksum         0x2D
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("DSDT.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000036)
{
    /*
    ...
    External (_SB_.PCI0.PEGP.GFX0.EPON, MethodObj)    // Warning: Unresolved Method, guessing 0 arguments (may be incorrect, see warning above)
    ...
    External (_SB_.PCI0.PEGP.HPME, MethodObj)    // 0 Arguments
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDDFC5C18, 0x02B2)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (SIO1)
                {
                    ...
                    CreateWordField (CRS1, \_SB.PCI0.LPCB.SIO1._Y19._INT, IRQM)  // _INT: Interrupts
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y1A._DMA, DMAM)  // _DMA: Direct Memory Access
                    CreateWordField (CRS1, \_SB.PCI0.LPCB.SIO1._Y1B._MIN, IO11)  // _MIN: Minimum Base Address
                    CreateWordField (CRS1, \_SB.PCI0.LPCB.SIO1._Y1B._MAX, IO12)  // _MAX: Maximum Base Address
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y1B._LEN, LEN1)  // _LEN: Length
                    ...
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1C._INT, IRQE)  // _INT: Interrupts
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1D._DMA, DMAE)  // _DMA: Direct Memory Access
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1E._MIN, IO21)  // _MIN: Minimum Base Address
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1E._MAX, IO22)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1E._LEN, LEN2)  // _LEN: Length
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1F._MIN, IO31)  // _MIN: Minimum Base Address
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1F._MAX, IO32)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1F._LEN, LEN3)  // _LEN: Length
...
{If (LLessEqual (Arg0, 0x5E))
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDDE42D18, 0x10)
            ...
            If (TCMF)
{
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xDDFC3018, 0x04EC)
            ...
            Method (GXDV, 1, Serialized)//by hale
            {
                Name (PRF1, 0x03)
                Name (PRF2, 0x01)
                ...
                OperationRegion (PRFA, SystemMemory, 0xDDFC1018, 0x00F0)
